...
/// chuc nang so 3: tinh ti�n cho quan karaoke
void cn3()
{
	// input
	...
	if(gioBD>=14 && gioBD <=17){// giam 10% th� con 90% 
		tienthanhtoan = tienthanhtoan*0.9;
		}
	/// output
	printf(" So ti�n quy khach can thanh toan: %.0f \n",tienthanhtoan);
}
...
/// chuc nang so 6: t�nh l�i xuat vay ng�n h�ng vay tra g�p
int cn6(){
	...
	int tiengoc= tienvay/ 12; /// tien goc phai tra hang th�ng
...
int main() {
	...
	while(1){
		...
		printf("\t\t|\tChuc nang so 1: Chuong trinh Kiem tra so nguy�n                                         |\n");
		printf("\t\t|\tChuc nang so 2. Chuong trinh Tim Uoc so chung v� boi so chung cua 2 so                  |\n");
